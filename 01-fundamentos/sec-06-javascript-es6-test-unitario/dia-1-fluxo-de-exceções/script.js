...
const showPromo = (name, number) => {
  ...
  } finally { // os dados desaparecem ao clicar no botão enviar
...
// const schoolMedia = (n1, n2, n3, n4) => {
//   try {
//     validNumber(n1, n2, n3, n4);
//     let sum = n1 + n2 + n3 + n4;
//     let media = sum / 4;
//     return media;
//   } catch (err) {
...
//   }  
// }
// console.log(schoolMedia(6, 5, 8, 7));